...
def test_qiskit_run_and_measure() -> None:
    """Test QiskitSimulator.run_and_measure with Bell state."""
...
def test_qiskit_run_and_measure_deterministic() -> None:
    """Test QiskitSimulator.run_and_measure with deterministic circuit."""
